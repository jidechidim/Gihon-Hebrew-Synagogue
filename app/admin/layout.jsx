...
export default function AdminLayout({ children }) {
  ...
  // NOTE: removed transparent scroll effect — header remains solid
  ...
  const solidHeader = true; // always use the solid header style in admin
    ...
    <SessionContext.Provider value={session}>
      ...
      {showNav && (
        ...
        >
          <div className="container mx-auto flex justify-between items-center px-4 py-3 nav-wrap">
            ...
            {/* Desktop Logout (separated to align right) */}
            <button
              onClick={logout}
      ...
      <footer className="site-footer" id="donate">
        ...
        <div className="container footer-bottom">
          <small>© {new Date().getFullYear()} Gihon Hebrew Synagogue. All rights reserved.</small>
        </div>
      </footer>
